...
function esconderTodos() {
  exibirTodos();
  const produtosNovidades = Array.from(
    catalogoProdutos.getElementsByClassName("novidades")
  );

  for (const produto of produtosNovidades) {
...
export function inicializarFiltros() {
  ...
  document
    .getElementById("exibir-novidades")
    .addEventListener("click", esconderTodos);
}
